...
void til::frame_size_calculator::do_address_node(til::address_node * const node, int lvl) {
  // EMPTY
}
void til::frame_size_calculator::do_variable_node(cdk::variable_node * const node, int lvl) {
  // EMPTY
}
void til::frame_size_calculator::do_pointer_index_node(til::pointer_index_node * const node, int lvl) {
  // EMPTY
}
...
void til::frame_size_calculator::do_function_node(til::function_node * const node, int lvl) {
  // EMPTY
}
