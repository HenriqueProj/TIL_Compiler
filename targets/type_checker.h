...
namespace til {
  ...
  protected:
    ...
    void processUnary(cdk::unary_operation_node *const node, int lvl, bool acceptDoubles);
    void processBinaryArithmetic(cdk::binary_operation_node *const node, int lvl, bool acceptDoubles, bool acceptOnePointer, bool acceptBothPointers);
    void processBinaryPredicate(cdk::binary_operation_node *const node, int lvl, bool acceptDoubles, bool acceptPointers);
